...
urlpatterns = [
    ...
    path('user_view_sentiment/', usr.user_view_sentiment, name="user_view_sentiment"),
    path('user_classifiers/', usr.user_classifiers, name='user_classifiers'),
    path('app/', usr.app, name='app'),
    ...
    path("AdminDataset/", admins.AdminDataset, name="AdminDataset"),
]